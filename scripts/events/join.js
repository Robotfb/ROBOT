...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি বস সৌরভ তোমাদের মাঝে😎🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} 𝐒𝐎𝐔𝐑𝐀𝐕-𝐁𝐎𝐓 𝐂𝐎𝐍𝐍𝐄𝐂𝐓𝐄𝐃«\n\n𝐍𝐎𝐌𝐎𝐒𝐊𝐀𝐑☘️
<------------------------------>  
...
🟢𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐄𝐌𝐀𝐈𝐋: sourabnath@gmail.com`, attachment: fs.createReadStream(__dirname + "/Nayan/join/received_371034495743341.mp4")}, threadID));
})
.catch(error => {
    console.error(error);
});
